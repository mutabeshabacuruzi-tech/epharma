...
def ajouterCategorie(request):
    ...
    produit = models.produits.objects.all()
    context = {
...
class Catalogue(View):
    template_name = "catalogue/catalogue_index.html"
    def get(self, request, *args, **kwargs):
        tous_les_produis_en_stock = models.produits.objects.all()
        info = {
            "categories": models.Categories.objects.all(),
            "produits": tous_les_produis_en_stock,
        }
