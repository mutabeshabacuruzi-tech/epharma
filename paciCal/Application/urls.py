...
calvin_controleur = [
    path('logout', Controllers.logoutControler, name="logout user")
]
calvin_views = [
    path('catalogue', views.Catalogue.as_view(), name="catalogue en ligne")
]
urlpatterns = [
    ...
    path('AjouterCategorie', Controllers.AjoutCategorie_controller, name='ControlerAjouterCategorie'),
    path('EffacerCategorie/<categorie>', Controllers.EffacerCategorie_controller, name='supprimerCategorie'),
    ...
    path('stock1', views.tableau_stock, name='stock'),
    # path('stock2', Controllers.ajoutStock, name='stock1'),
] + calvin_controleur + calvin_views
