"""
Django settings for paci project.
...
SECRET_KEY = 'django-insecure-m!s*al(zl^+mc+y2_()8944u%9l($ksy^ybug@(thh!+m@0=73'
...
WSGI_APPLICATION = 'paci.wsgi.application'
